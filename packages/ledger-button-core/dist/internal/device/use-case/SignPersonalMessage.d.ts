...
export declare class SignPersonalMessage {
    ...
    constructor(loggerFactory: LoggerPublisherFactory, deviceManagementKitService: DeviceManagementKitService, storageService: StorageService, dappConfigService: DAppConfigService, config: Config);
