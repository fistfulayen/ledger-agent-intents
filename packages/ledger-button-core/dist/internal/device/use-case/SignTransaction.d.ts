...
export declare class SignTransaction {
    ...
    constructor(loggerFactory: LoggerPublisherFactory, gasFeeEstimationService: GasFeeEstimationService, storageService: StorageService, signRawTransaction: SignRawTransaction, contextService: ContextService);
