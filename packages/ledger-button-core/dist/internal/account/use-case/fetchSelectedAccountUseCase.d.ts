...
export declare class FetchSelectedAccountUseCase {
    ...
    constructor(loggerFactory: LoggerPublisherFactory, contextService: ContextService, ledgerSyncService: LedgerSyncService, fetchAccountsUseCase: FetchAccountsUseCase, hydrateWithBalanceUseCase: HydrateAccountWithBalanceUseCase, hydrateWithFiatUseCase: HydrateAccountWithFiatUseCase, hydrateWithTxHistoryUseCase: HydrateAccountWithTxHistoryUseCase);
