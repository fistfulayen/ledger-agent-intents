...
export declare class DefaultLedgerSyncService implements LedgerSyncService {
    ...
    constructor(loggerFactory: LoggerPublisherFactory, deviceManagementKitService: DeviceManagementKitService, storageService: StorageService, getOrCreateKeyPairUseCase: GetOrCreateKeyPairUseCase, config: Config);
